...
const QuotaUsage = ({ 
  ...
  // API лимиты (из существующей логики)
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-200/50 dark:border-gray-700/50 ${className}`}>
      ...
      {/* БЛОК 2: API лимиты (из существующего кода) */}
      {quota && (
        <>
          {/* Дневной лимит API */}
          <div className="mb-4">
      ...
      {/* БЛОК 4: Кнопка апгрейда (если не показана выше) */}
