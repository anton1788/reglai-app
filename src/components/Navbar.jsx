          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 flex-shrink-0">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-gray-800 dark:text-white">Реглай</span>
              </div>
              <button
                onClick={() => setIsMobileMenuOpen(false)}
                className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
              ...
              <div className="mb-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {(userRole === 'manager' || userRole === 'supply_admin') && (
                    <button
                      onClick={() => { onInvite?.(); setIsMobileMenuOpen(false); }}
                      className="flex items-center gap-2 px-3 py-2 text-xs bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-lg hover:bg-green-100 transition-colors"
                    >
                ...
                {filteredNavItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-3 py-3 text-sm rounded-xl transition-colors ${
                        isActive
                          ? 'bg-gradient-to-r from-[#4A6572]/10 to-[#344955]/10 text-[#344955] dark:text-[#F9AA33]'
